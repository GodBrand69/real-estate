      ...
      >
        <div className="bg-[#1a1a2e] rounded-2xl p-8 shadow-[0_0_30px_rgba(0,255,159,0.1)] border border-[#2a2a3a] backdrop-blur-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-[#00ff9f]" />
                <input
                  type="text"
                  value={name}
          ...
          >
            ...
            <Link to="/login" className="text-[#00ff9f] hover:text-[#00ffff] transition-colors">
              Sign in
            </Link>
          </motion.p>
        </div>
